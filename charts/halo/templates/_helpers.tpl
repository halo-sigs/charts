...
{{- if .Values.postgresql.enabled }}
    {{- printf "r2dbc:pool:postgresql://%s:%s/%s" (include "halo.databaseHost" .) (include "halo.databasePort" .) (include "halo.databaseName" .) -}}
{{- else -}}
    {{- printf "r2dbc:pool:%s://%s:%d/%s" (.Values.externalDatabase.platform) (.Values.externalDatabase.host) (.Values.externalDatabase.port | int) (.Values.externalDatabase.database) -}}
{{- end -}}
{{- end -}}
...
{{- if and (not .Values.postgresql.enabled) (or (empty .Values.externalDatabase.host) (empty .Values.externalDatabase.port) (empty .Values.externalDatabase.user) (empty .Values.externalDatabase.password) (empty .Values.externalDatabase.database)) -}}
halo: database
